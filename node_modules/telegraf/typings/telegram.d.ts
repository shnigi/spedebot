...
declare class Telegram extends ApiClient {
     ...
     */
    getFileLink(fileId: string | tt.File): Promise<string | URL>;
    /**
     ...
     */
    sendMediaGroup(chatId: number | string, media: ReadonlyArray<tt.InputMediaPhoto | tt.InputMediaVideo>, extra?: tt.ExtraMediaGroup): Promise<(tt.Message.DocumentMessage | tt.Message.AudioMessage | tt.Message.PhotoMessage | tt.Message.VideoMessage)[]>;
    /**
     * Send a native poll.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     ...
     */
    kickChatMember(chatId: number | string, userId: number, untilDate?: number): Promise<true>;
    /**
