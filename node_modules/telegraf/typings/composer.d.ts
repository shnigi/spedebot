...
declare type PropOr<T, P extends string, D> = T extends Record<P, infer V> ? V : D;
...
declare type MatchedContext<C extends Context, T extends tt.UpdateType | tt.MessageSubType> = GuardedContext<C, MountMap[T]>;
/**
 * Narrows down `Context['update']` and some derived properties.
 */
declare type GuardedContext<C extends Context, U extends Omit<tt.Update, 'update_id'>> = C & {
...
export declare class Composer<C extends Context> implements MiddlewareObj<C> {
     ...
     */
    guard<U extends tt.Update>(guardFn: (update: tt.Update) => update is U, ...fns: NonemptyReadonlyArray<Middleware<GuardedContext<C, U>>>): this;
    /**
     ...
     */
    gameQuery(...fns: NonemptyReadonlyArray<Middleware<GuardedContext<C, GameQueryUpdate>>>): this;
    /**
     ...
     */
    static guard<C extends Context, U extends tt.Update>(guardFn: (u: tt.Update) => u is U, ...fns: NonemptyReadonlyArray<Middleware<GuardedContext<C, U>>>): MiddlewareFn<C>;
    /**
     ...
     */
    static gameQuery<C extends Context>(...fns: NonemptyReadonlyArray<Middleware<GuardedContext<C, GameQueryUpdate>>>): MiddlewareFn<C>;
